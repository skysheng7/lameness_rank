...
data_path_2='master_all_responses_KINov-11-2023_to_KI_resub2Nov-11-2023_Kiyomi.csv'
...
winner_loser_df[["expert"]] = "KI"

winner_loser_df.to_csv(os.path.join(expert_response_dir, 'winner_loser_KI.csv'), index=False)
final_df.to_csv(os.path.join(expert_response_dir, 'cowLR_response_KI.csv'), index=False)

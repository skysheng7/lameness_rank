...
master_submitted_tasks_tracker = pd.read_csv(os.path.join(output_dir, ("re_submitted_tracker_KI2Nov-11-2023.csv")))
...
master_worker_response_tracker.to_csv(os.path.join(output_dir, ('master_worker_response_tracke_KI_resub2' + today + '.csv')), index=False)
master_approved_responses.to_csv(os.path.join(output_dir, ('master_approved_responses_KI_resub2' + today + '.csv')), index=False)
master_rejected_responses.to_csv(os.path.join(output_dir, ('master_rejected_responses_KI_resub2' + today + '.csv')), index=False)
master_all_responses.to_csv(os.path.join(output_dir, ('master_all_responses_KI_resub2' + today + '.csv')), index=False)
...
master_submitted_tasks_tracker = pd.read_csv(os.path.join(output_dir, ("all_submitted_tracker_KI_Nov-11-2023.csv")))
master_worker_response_tracker = pd.read_csv(os.path.join(output_dir, ("master_worker_response_tracke_KINov-11-2023.csv")))
...
unsubmitted_master_submitted_tasks_tracker.to_csv(os.path.join(output_dir, ('re_submitted_tracker_KI2' + today + '.csv')))
...
# Kiyomi
merge_responses(["KINov-11-2023", "KI_resubNov-11-2023", "KI_resub2Nov-11-2023"], ['ARUXAWT9AUG92', 'A2EE2N0X2ZPJ5E'], 'Kiyomi', output_dir, "05-Amazon_MTurk_expert_response_30cow_pairwise/results/KI")

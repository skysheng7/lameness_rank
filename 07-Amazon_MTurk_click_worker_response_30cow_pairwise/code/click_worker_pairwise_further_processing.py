...
import math
import os
os.chdir("/Users/skysheng/Library/CloudStorage/OneDrive-UBC/University of British Columbia/Research/PhD Project/Amazon project phase 2/Sora Jeong/code/Amazon MTurk click worker response")
...
expert_response_dir = "/Users/skysheng/Library/CloudStorage/OneDrive-UBC/University of British Columbia/Research/PhD Project/Amazon project phase 2/Sora Jeong/results/Amazon MTurk click worker response"
answer_dir = "/Users/skysheng/Library/CloudStorage/OneDrive-UBC/University of British Columbia/Research/PhD Project/Amazon project phase 2/Sora Jeong/results/html_click_workers"
...
final_df_r1, final_df_pass_pos_r1, final_df_pass_neg_r1, final_df_pass_both_r1 = convert_pairwise_to_long(answer_dir, expert_response_dir, data_path_1, data_path_2, "HIT0_selected_worker")

####### second launch: 10 HITs #######
# ~19 click workers per HIT
data_path_2='master_all_responses_click_worker_Sep-13-2023.csv'
final_df_r2, final_df_pass_pos_r2, final_df_pass_neg_r2, final_df_pass_both_r2 = convert_pairwise_to_long(answer_dir, expert_response_dir, data_path_1, data_path_2, "10HITs")

####### third launch: 44 HITs ######
data_path_2='master_all_responses_click_worker_44HITsSep-13-2023.csv'
final_df_r3, final_df_pass_pos_r3, final_df_pass_neg_r3, final_df_pass_both_r3 = convert_pairwise_to_long(answer_dir, expert_response_dir, data_path_1, data_path_2, "44HITs")
...
# export as csv
final_df.to_csv(f'cowLR_response_clickWorker_55HITS.csv', index=False)
final_df_pass_pos.to_csv(f'cowLR_response_clickWorker_55HITS_pass_pos.csv', index=False)
final_df_pass_neg.to_csv(f'cowLR_response_clickWorker_55HITS_pass_neg.csv', index=False)
final_df_pass_both.to_csv(f'cowLR_response_clickWorker_55HITS_pass_both.csv', index=False)
...
winner_loser_df.to_csv('winner_loser_55HITs.csv', index=False)
...
winner_loser_avg.to_csv('winner_loser_avg_55HITs.csv', index=False)
...
final_df_sampled.to_csv('cowLR_response_clickWorker_sampled_55HITS.csv', index=False)
winner_loser_sampled = create_winner_loser_degree_df(final_df_sampled)
winner_loser_sampled.to_csv('winner_loser_sampled_55HITs.csv', index=False)
...
winner_loser_sampled_delete.to_csv('winner_loser_sampled_delete_pairs_55HITs.csv', index=False)
...
winner_loser_sampled_exchannge0.to_csv('winner_loser_sampled_exchange0_55HITs.csv', index=False)
...
winner_loser_sampled_ind_exchannge0.to_csv('winner_loser_sampled_ind_exchange0_55HITs.csv', index=False)
...
winner_loser_milestone_min.to_csv('winner_loser_milestone_min_55HITs.csv', index=False)
...
winner_loser_milestone_max.to_csv('winner_loser_milestone_max_55HITs.csv', index=False)